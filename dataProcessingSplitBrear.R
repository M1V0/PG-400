...
for (i in 1:756){
  ...
  temp_data <- select(temp_data,CP5, CP1, CP2, CP6, P7, P3, Pz, P4, P8, PO3, PO4, O1, O2, Oz, -time) #remove the time record as it is unnecessary
...
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/rear/1Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/rear/1Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/rear/1TrainLabels.Rda")
saveRDS(Split.i, file="~/PG-400/data2/split B/rear/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/rear/2Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/rear/2Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/rear/2TrainLabels.Rda")
saveRDS(Split.ii, file="~/PG-400/data2/split B/rear/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/rear/3Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/rear/3Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/rear/3TrainLabels.Rda")
saveRDS(Split.iii, file="~/PG-400/data2/split B/rear/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/rear/4Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/rear/4Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/rear/4TrainLabels.Rda")
saveRDS(Split.iv, file="~/PG-400/data2/split B/rear/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/rear/5Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/rear/5Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/rear/5TrainLabels.Rda")
saveRDS(Split.v, file="~/PG-400/data2/split B/rear/5TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/rear/6Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/rear/6Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/rear/6TrainLabels.Rda")
saveRDS(Split.vi, file="~/PG-400/data2/split B/rear/6TestLabels.Rda")
