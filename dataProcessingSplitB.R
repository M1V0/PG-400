...
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/1Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/1Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/1TrainLabels.Rda")
saveRDS(Split.i, file="~/PG-400/data2/split B/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/2Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/2Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/2TrainLabels.Rda")
saveRDS(Split.ii, file="~/PG-400/data2/split B/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/3Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/3Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/3TrainLabels.Rda")
saveRDS(Split.iii, file="~/PG-400/data2/split B/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/4Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/4Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/4TrainLabels.Rda")
saveRDS(Split.iv, file="~/PG-400/data2/split B/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/5Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/5Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/5TrainLabels.Rda")
saveRDS(Split.v, file="~/PG-400/data2/split B/5TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/6Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/6Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/6TrainLabels.Rda")
saveRDS(Split.vi, file="~/PG-400/data2/split B/6TestLabels.Rda")
