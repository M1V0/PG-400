...
TrainingNames <- readRDS(#paste("data2/Split A/", fold, "TrainLabels.Rda", sep = "")
  paste("data2/Freqs/delta/", fold, "TrainLabels.Rda", sep = "")
)
TestingNames <- readRDS(#paste("data2/Split A/", fold, "TestLabels.Rda", sep = "")   
  paste("data2/Freqs/delta/", fold, "TestLabels.Rda", sep = "")
)
...
TrainingSet <- readRDS(
  paste("data2/white/", channels, "/", fold , "Train.Rda", sep = "")
)
TestingSet <- readRDS(
  paste("data2/white/", channels, "/", fold , "Test.Rda", sep = "")
)
