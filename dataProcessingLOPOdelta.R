...
saveRDS(
TrainingSetMod,
file = paste("~/PG-400/data2/LOPO/delta/", ppt, "Train.Rda", sep = ""))
saveRDS(
TestingSetMod,
file = paste("~/PG-400/data2/LOPO/delta/", ppt, "Test.Rda", sep = ""))
saveRDS(
TrainingNames,
file = paste("~/PG-400/data2/LOPO/delta/", ppt, "TrainLabels.Rda", sep = ""))
saveRDS(TestingNames, paste(file = "~/PG-400/data2/LOPO/delta/", ppt, "TestLabels.Rda", sep = ""))
