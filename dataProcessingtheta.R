...
file_list <- list.files(path="~/PG-400/data2/rawFreqs/theta")
...
saveRDS(TrainingSetMod, file="data2/Freqs/theta/32/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/theta/32/1Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/theta/1TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/theta/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/theta/32/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/theta/32/2Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/theta/2TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/theta/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/theta/32/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/theta/32/3Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/theta/3TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/theta/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/theta/32/4Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/theta/32/4Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/theta/4T1rainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/theta/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/theta/32/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/theta/32/5Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/theta/5TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/theta/5TestLabels.Rda")
