...
TrainingSet1 <- array(numeric(),c(1024,14,0))
for (i in 1:756){
  
  temp_data <- fread(TrainingNames[i], stringsAsFactors = F) #read in files using the fread function
  temp_data <- select(temp_data,Fp2,AF4,F4,F8,FC2,FC6,T8,C4,CP2,CP6,P4,P8, PO4, O2, -time) #remove the time record as it is unnecessary
...
TrainingSet2 <- array(numeric(),c(1024,14,0))
for (i in 757:1512){
...
TrainingSet3 <- array(numeric(),c(1024,14,0))
for (i in 1513:2268){
...
TrainingSet4 <- array(numeric(),c(1024,14,0))
...
TestingSet <- array(numeric(),c(1024,14,0))
...
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/right/1Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/right/1Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/right/1TrainLabels.Rda")
saveRDS(Split.i, file="~/PG-400/data2/split B/right/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/right/2Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/right/2Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/right/2TrainLabels.Rda")
saveRDS(Split.ii, file="~/PG-400/data2/split B/right/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/right/3Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/right/3Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/right/3TrainLabels.Rda")
saveRDS(Split.iii, file="~/PG-400/data2/split B/right/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/right/4Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/right/4Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/right/4TrainLabels.Rda")
saveRDS(Split.iv, file="~/PG-400/data2/split B/right/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/right/5Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/right/5Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/right/5TrainLabels.Rda")
saveRDS(Split.v, file="~/PG-400/data2/split B/right/5TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/right/6Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/right/6Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/right/6TrainLabels.Rda")
saveRDS(Split.vi, file="~/PG-400/data2/split B/right/6TestLabels.Rda")
