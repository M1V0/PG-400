...
#bandpass butterworth filter of 1 between 4 and 8 Hz ----

hc.01signal[,2:33] <- eegfilter(hc.01signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.02signal[,2:33] <- eegfilter(hc.02signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.04signal[,2:33] <- eegfilter(hc.04signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.07signal[,2:33] <- eegfilter(hc.07signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.08signal[,2:33] <- eegfilter(hc.08signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.10signal[,2:33] <- eegfilter(hc.10signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.18signal[,2:33] <- eegfilter(hc.18signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.20signal[,2:33] <- eegfilter(hc.20signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.21signal[,2:33] <- eegfilter(hc.21signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.24signal[,2:33] <- eegfilter(hc.24signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.25signal[,2:33] <- eegfilter(hc.25signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.29signal[,2:33] <- eegfilter(hc.29signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.30signal[,2:33] <- eegfilter(hc.30signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.31signal[,2:33] <- eegfilter(hc.31signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.32signal[,2:33] <- eegfilter(hc.32signal[,2:33], 512, lower = 4, upper = 8, order = 1)
hc.33signal[,2:33] <- eegfilter(hc.33signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.03.off.signal[,2:33] <- eegfilter(pd.03.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.05.off.signal[,2:33] <- eegfilter(pd.05.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.06.off.signal[,2:33] <- eegfilter(pd.06.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.09.off.signal[,2:33] <- eegfilter(pd.09.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.11.off.signal[,2:33] <- eegfilter(pd.11.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.12.off.signal[,2:33] <- eegfilter(pd.12.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.13.off.signal[,2:33] <- eegfilter(pd.13.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.14.off.signal[,2:33] <- eegfilter(pd.14.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.16.off.signal[,2:33] <- eegfilter(pd.16.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.17.off.signal[,2:33] <- eegfilter(pd.17.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.19.off.signal[,2:33] <- eegfilter(pd.19.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.22.off.signal[,2:33] <- eegfilter(pd.22.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.23.off.signal[,2:33] <- eegfilter(pd.23.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.26.off.signal[,2:33] <- eegfilter(pd.26.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)
pd.28.off.signal[,2:33] <- eegfilter(pd.28.off.signal[,2:33], 512, lower = 4, upper = 8, order = 1)


## split into time windows and save into raw theta folder ----

for(i in seq(0, nrow(data.frame(hc1$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.01signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.1.", i, ".csv", sep = "")))
}
for(i in seq(0, nrow(data.frame(hc2$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.02signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.2.", i, ".csv", sep = "")))
}
for(i in seq(0, nrow(data.frame(hc4$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.04signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.4.", i, ".csv", sep = "")))
}
for(i in seq(0, nrow(data.frame(hc7$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.07signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.7.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc8$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.08signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.8.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc10$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.10signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.10.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc18$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.18signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.18.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc20$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.20signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.20.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc21$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.21signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.21.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc24$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.24signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.24.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc25$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.25signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.25.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc29$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.29signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.29.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc30$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.30signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.30.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc31$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.31signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.31.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc32$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.32signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.32.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(hc33$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(hc.33signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/hc.33.", i, ".csv", sep = "")))
}
...
for(i in seq(0, nrow(data.frame(pd3.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.03.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.3.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd5.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.05.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.5.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd6.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.06.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.6.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd9.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.09.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.9.", i, ".csv", sep = "")))
}


for(i in seq(0, nrow(data.frame(pd11.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.11.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.11.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd12.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.12.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.12.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd13.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.13.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.13.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd14.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.14.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.14.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd16.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.16.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.16.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd17.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.17.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.17.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd19.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.19.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.19.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd22.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.22.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.22.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd23.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.23.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.23.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd26.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.26.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.26.", i, ".csv", sep = "")))
}

for(i in seq(0, nrow(data.frame(pd28.Off$Fp1$signal))/512-2, 2)) {
  write_csv(dplyr::filter(as.data.frame(pd.28.off.signal), time >= i, time <i+2), (paste("~/PG-400/data2/rawFreqs/theta/pd.off.28.", i, ".csv", sep = "")))
