...
saveRDS(TrainingSetMod, file="data2/Split A/32/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/32/1Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/32/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/32/2Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/32/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/32/3Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/32/4Train.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/32/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/32/5Test.Rda")
