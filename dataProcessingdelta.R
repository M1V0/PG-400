...
file_list <- list.files(path="~/PG-400/data2/rawFreqs/delta")
...
saveRDS(TrainingSetMod, file="data2/Freqs/delta/32/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/delta/32/1Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/delta/1TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/delta/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/delta/32/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/delta/32/2Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/delta/2TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/delta/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/delta/32/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/delta/32/3Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/delta/3TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/delta/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/delta/32/4Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/delta/32/4Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/delta/4T1rainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/delta/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/delta/32/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/delta/32/5Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/delta/5TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/delta/5TestLabels.Rda")
