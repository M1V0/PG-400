...
saveRDS(TrainingSetMod, file="data2/Split A/5/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/5/1Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/5/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/5/2Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/5/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/5/3Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/5/4Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/5/4Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/5/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/5/5Test.Rda")
