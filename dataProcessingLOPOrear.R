...
temp_data <-
select(temp_data,CP5, CP1, CP2, CP6, P7, P3, Pz, P4, P8, PO3, PO4, O1, O2, Oz, -time) #remove the time record as it is unnecessary
temp_data <-
...
TrainingSet5 <- array(numeric(), c(1024, 14, 0))
...
saveRDS(
TrainingSetMod,
file = paste("~/PG-400/data2/LOPO/rear/", ppt, "Train.Rda", sep = ""))
saveRDS(
TestingSetMod,
file = paste("~/PG-400/data2/LOPO/rear/", ppt, "Test.Rda", sep = ""))
saveRDS(
TrainingNames,
file = paste("~/PG-400/data2/LOPO/rear/", ppt, "TrainLabels.Rda", sep = ""))
saveRDS(TestingNames, paste(file = "~/PG-400/data2/LOPO/rear/", ppt, "TestLabels.Rda", sep = ""))
