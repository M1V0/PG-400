...
saveRDS(TrainingSetMod, file="data2/Split A/mid/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/mid/1Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/mid/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/mid/2Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/mid/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/mid/3Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/mid/4Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/mid/4Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/mid/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/mid/5Test.Rda")
