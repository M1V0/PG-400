...
saveRDS(TrainingSetMod, file="data2/Split A/right/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/right/1Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/right/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/right/2Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/right/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/right/3Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/right/4Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/right/4Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/right/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/right/5Test.Rda")
