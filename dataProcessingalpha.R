...
file_list <- list.files(path="~/PG-400/data2/rawFreqs/alpha")
...
saveRDS(TrainingSetMod, file="data2/Freqs/alpha/32/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/alpha/32/1Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/alpha/1TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/alpha/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/alpha/32/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/alpha/32/2Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/alpha/2TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/alpha/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/alpha/32/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/alpha/32/3Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/alpha/3TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/alpha/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/alpha/32/4Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/alpha/32/4Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/alpha/4T1rainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/alpha/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/alpha/32/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/alpha/32/5Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/alpha/5TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/alpha/5TestLabels.Rda")