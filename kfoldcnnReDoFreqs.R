...
channels <- "delta" #can be alpha, beta, delta or theta
fold <- 1 #can be (1:5)
...
TrainingNames <- readRDS(paste("data2/Freqs/", channels, "/", fold, "TrainLabels.Rda", sep = "")
)
TestingNames <- readRDS(paste("data2/Freqs/", channels, "/", fold, "TestLabels.Rda", sep = "")
)
...
TrainingSet <- readRDS(
  paste("data2/Freqs/", channels, "/32/", fold , "Train.Rda", sep = "")
)
TestingSet <- readRDS(
  paste("data2/Freqs/", channels, "/32/", fold , "Test.Rda", sep = "")
)
