...
for (i in 1:756){
  ...
  temp_data <- select(temp_data,FP1,AF3,F7,F3,FC5,FC1,T7,C3,CP5,CP1,P7,P3, PO3, O1, -time) #remove the time record as it is unnecessary
...
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/left/1Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/left/1Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/left/1TrainLabels.Rda")
saveRDS(Split.i, file="~/PG-400/data2/split B/left/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/left/2Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/left/2Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/left/2TrainLabels.Rda")
saveRDS(Split.ii, file="~/PG-400/data2/split B/left/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/left/3Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/left/3Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/left/3TrainLabels.Rda")
saveRDS(Split.iii, file="~/PG-400/data2/split B/left/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/left/4Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/left/4Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/left/4TrainLabels.Rda")
saveRDS(Split.iv, file="~/PG-400/data2/split B/left/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/left/5Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/left/5Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/left/5TrainLabels.Rda")
saveRDS(Split.v, file="~/PG-400/data2/split B/left/5TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/left/6Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/left/6Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/left/6TrainLabels.Rda")
saveRDS(Split.vi, file="~/PG-400/data2/split B/left/6TestLabels.Rda")
