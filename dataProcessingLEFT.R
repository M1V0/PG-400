...
saveRDS(TrainingSetMod, file="data2/Split A/left/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/left/1Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/left/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/left/2Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/left/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/left/3Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/left/4Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/left/4Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/left/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/left/5Test.Rda")
