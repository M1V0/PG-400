...
TrainingSet1 <- array(numeric(),c(1024,5,0))
for (i in 1:756){
  
  temp_data <- fread(TrainingNames[i], stringsAsFactors = F) #read in files using the fread function
  temp_data <- select(temp_data, T7, C3, Cz, C4, T8, -time) #remove the time record as it is unnecessary
...
TrainingSet2 <- array(numeric(),c(1024,5,0))
for (i in 757:1512){
...
TrainingSet3 <- array(numeric(),c(1024,5,0))
for (i in 1513:2268){
...
TrainingSet4 <- array(numeric(),c(1024,5,0))
...
TestingSet <- array(numeric(),c(1024,5,0))
...
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/5/1Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/5/1Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/5/1TrainLabels.Rda")
saveRDS(Split.i, file="~/PG-400/data2/split B/5/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/5/2Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/5/2Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/5/2TrainLabels.Rda")
saveRDS(Split.ii, file="~/PG-400/data2/split B/5/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/5/3Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/5/3Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/5/3TrainLabels.Rda")
saveRDS(Split.iii, file="~/PG-400/data2/split B/5/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/5/4Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/5/4Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/5/4TrainLabels.Rda")
saveRDS(Split.iv, file="~/PG-400/data2/split B/5/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/5/5Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/5/5Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/5/5TrainLabels.Rda")
saveRDS(Split.v, file="~/PG-400/data2/split B/5/5TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/5/6Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/5/6Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/5/6TrainLabels.Rda")
saveRDS(Split.vi, file="~/PG-400/data2/split B/5/6TestLabels.Rda")
