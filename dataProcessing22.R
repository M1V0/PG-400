...
saveRDS(TrainingSetMod, file="data2/Split A/22/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/22/1Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/22/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/22/2Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/22/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/22/3Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/22/4Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/22/4Test.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Split A/22/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Split A/22/5Test.Rda")
