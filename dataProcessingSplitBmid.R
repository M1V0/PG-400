...
for (i in 1:756){
  ...
  temp_data <- select(temp_data,Fz, Cz, Pz, Oz, -time) #remove the time record as it is unnecessary
...
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/mid/1Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/mid/1Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/mid/1TrainLabels.Rda")
saveRDS(Split.i, file="~/PG-400/data2/split B/mid/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/mid/2Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/mid/2Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/mid/2TrainLabels.Rda")
saveRDS(Split.ii, file="~/PG-400/data2/split B/mid/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/mid/3Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/mid/3Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/mid/3TrainLabels.Rda")
saveRDS(Split.iii, file="~/PG-400/data2/split B/mid/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/mid/4Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/mid/4Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/mid/4TrainLabels.Rda")
saveRDS(Split.iv, file="~/PG-400/data2/split B/mid/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/mid/5Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/mid/5Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/mid/5TrainLabels.Rda")
saveRDS(Split.v, file="~/PG-400/data2/split B/mid/5TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="~/PG-400/data2/split B/mid/6Train.Rda")
saveRDS(TestingSetMod, file="~/PG-400/data2/split B/mid/6Test.Rda")
saveRDS(TrainingNames, file="~/PG-400/data2/split B/mid/6TrainLabels.Rda")
saveRDS(Split.vi, file="~/PG-400/data2/split B/mid/6TestLabels.Rda")
