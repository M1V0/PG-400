...
file_list <- list.files(path="~/PG-400/data2/rawFreqs/beta")
...
saveRDS(TrainingSetMod, file="data2/Freqs/beta/32/1Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/beta/32/1Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/beta/1TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/beta/1TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/beta/32/2Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/beta/32/2Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/beta/2TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/beta/2TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/beta/32/3Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/beta/32/3Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/beta/3TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/beta/3TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/beta/32/4Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/beta/32/4Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/beta/4T1rainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/beta/4TestLabels.Rda")
...
##finally save everything to load into memory at a later date
saveRDS(TrainingSetMod, file="data2/Freqs/beta/32/5Train.Rda")
saveRDS(TestingSetMod, file="data2/Freqs/beta/32/5Test.Rda")
saveRDS(TrainingNames, file="data2/Freqs/beta/5TrainLabels.Rda")
saveRDS(TestingNames, file = "data2/Freqs/beta/5TestLabels.Rda")
